...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_ACCOUNTS_TABLE = String.format("CREATE TABLE %s " +
                ...
                "PRIMARY KEY (%s, %s, %s), " +
                "FOREIGN KEY (%s) REFERENCES %s(%s))", TABLE_ACCOUNTS, ACCOUNTS_USER, ACCOUNTS_NAME,
    ...
    public void addAccount(User user, Account account) throws InvalidAccountException {
        // get database reference
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<Account> getAccounts(User user) {
        ...
        Cursor cursor = db.query(TABLE_ACCOUNTS, fields, whereClause, new String[] {user.getName()}, null, null, null);
        cursor.moveToFirst();
